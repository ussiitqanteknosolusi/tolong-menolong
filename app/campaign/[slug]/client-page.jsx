...
import {
  BadgeCheck, Clock, Users, Share2, Heart, ChevronLeft, Loader2
} from 'lucide-react';
...
export default function ClientPage({ campaign, donors }) {
  ...
  const handleDonateClick = () => {
    if (!user) {
      ...
      if (slug) router.push(`/login?redirect=/campaign/${slug}`);
      ...
      return (
        <div className="min-h-screen flex items-center justify-center">
             <div className="text-center">
                 <h1 className="text-2xl font-bold mb-4">Campaign Tidak Ditemukan</h1>
