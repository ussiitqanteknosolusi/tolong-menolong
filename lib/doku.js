  ...
  export async function createInvoice({
    ...
    // Tentukan notification URL — hanya gunakan jika bukan localhost
    ...
    const requestBody = {
      ...
      // Hanya injek additional_info jika notificationUrl publik tersedia
      ...(notificationUrl && {
        additional_info: {
    ...
    console.log('[DOKU] Notification URL:', notificationUrl || 'NOT SET (localhost detected, using dashboard config)');
